...
from the three candidate markers. Instead, it is the \emph{Bayesian best-choice
marker} for the corresponding production condition: the marker with the
highest posterior probability under the cost-augmented noisy-threshold RSA model fitted
...
from the three candidates. Instead, for each of the four production
